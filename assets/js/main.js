...
const translations = {
  zh: {
    ...
    "links.eyebrow": "LINKS · 数字邻居",
    "links.title": "连接彼此的<br><span>知识坐标。</span>",
    "links.subtitle": "一些值得持续访问的个人站点、学校、学院与研究机构。",
    "links.count": "个相关入口",
    "links.personal": "个人站点",
    "links.institutions": "学校与机构",
    "links.jiawan.desc": "个人主页与持续更新的数字空间",
    "links.g23yl.desc": "个人主页与学习记录",
    "links.hust": "华中科技大学",
    "links.hust.desc": "学校官方网站",
    "links.cs": "计算机科学与技术学院",
    "links.cs.desc": "学院官方网站",
    "links.hopcroft": "John Hopcroft 计算中心",
    "links.hopcroft.desc": "计算机科学研究中心",
  ...
  en: {
    ...
    "links.eyebrow": "LINKS · DIGITAL NEIGHBORS",
    "links.title": "Connected through<br><span>knowledge coordinates.</span>",
    "links.subtitle": "Personal sites, universities, schools, and research institutes worth revisiting.",
    "links.count": "related destinations",
    "links.personal": "Personal Sites",
    "links.institutions": "Universities & Institutes",
    "links.jiawan.desc": "A personal homepage and evolving digital space",
    "links.g23yl.desc": "A personal homepage and learning notes",
    "links.hust": "Huazhong University of Science and Technology",
    "links.hust.desc": "Official university website",
    "links.cs": "School of Computer Science and Technology",
    "links.cs.desc": "Official school website",
    "links.hopcroft": "John Hopcroft Center for Computer Science",
    "links.hopcroft.desc": "Computer science research center",
